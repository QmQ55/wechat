...
public class AgreementDialog {
    ...
    /**
     * Displays an agreement dialog to the user.
     *
     * <p>This method presents a dialog containing the provided agreement text, allowing the user to accept or decline the terms.
     * The dialog features a scrollable text view for displaying the agreement, a hint prompting careful reading, and "Agree" and "Disagree" buttons.</p>
     *
     * <p>Upon clicking "Agree", the agreement is marked as accepted, and the {@link AgreementCallback#onAgreed()} method is invoked.
     * If "Disagree" is selected, the {@link AgreementCallback#onDisagreed()} method is called.</p>
     *
     * <p>The dialog is non-cancelable, forcing the user to explicitly choose to agree or disagree.</p>
     *
     * @param context The Android context used to create the dialog.
     * @param agreementText The text of the agreement to be displayed.
     * @param callback An {@link AgreementCallback} instance that will receive the user's response (agree or disagree).
     */
    private static void showAgreement(Context context, String agreementText, AgreementCallback callback) {
        ...
        hintText.setTextColor(Color.GRAY); // 使用 android.graphics.Color
